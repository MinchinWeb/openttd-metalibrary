/* Fibonacci Heap (Min), v.4-GS, r.144 [2011-12-03],
...
class _MinchinWeb_Fibonacci_Heap_Min_Info {
	function GetVersion()       { return 4; }
	function GetRevision()		{ return 144; }
	function GetDate()          { return "2011-12-03"; }
	function GetName()          { return "Fibonacci Heap (Min) (MinchinWeb) Library"; }
}

class _MinchinWeb_Fibonacci_Heap_Min_ {
	_max = null;
	_max_index = 0;
	_max_priority = 0;
	_count = 0;
	...
	function GetVersion()       { return _MinchinWeb_Fibonacci_Heap_Min_Info.GetVersion(); }
	function GetRevision()		{ return _MinchinWeb_Fibonacci_Heap_Min_Info.GetRevision(); }
	function GetDate()          { return _MinchinWeb_Fibonacci_Heap_Min_Info.GetDate(); }
	function GetName()          { return _MinchinWeb_Fibonacci_Heap_Min_Info.GetName(); }
};

function _MinchinWeb_Fibonacci_Heap_Min_::Insert(item, priority) {
...
function _MinchinWeb_Fibonacci_Heap_Min_::Pop() {
...
function _MinchinWeb_Fibonacci_Heap_Min_::Peek() {
	if (_count == 0) return null;
	return _max.item;
}

function _MinchinWeb_Fibonacci_Heap_Min_::Count() {
	return _count;
}

function _MinchinWeb_Fibonacci_Heap_Min_::Exists(item) {
 ...
 */
function _MinchinWeb_Fibonacci_Heap_Min_::ExistsIn(list, item) {
 ...
 */
class _MinchinWeb_Fibonacci_Heap_Min_.Node {
	degree = null;
	child = null;
