...
class MinchinWeb extends AILibrary {
	...
	function GetDescription() { return "Minchinweb's MetaLibrary containing a Road Pathfinder, a 'Spiral Walker,' a 'Waterbody Check,' Array functions and some other random functions. (v.1, r.121)"; }
